  ...
  return (
    ...
    >
      <Link href={`/maps/${map.slug}`} className="block">
        {/* Compact Card - Always takes up space in grid */}
        <div
          className={`bg-white rounded-lg border p-3 sm:p-4 transition-all duration-200 ${
            featured
        ...
        {/* Floating Expanded Card - Overlays on hover, doesn't affect layout */}
        {isHovered && (
          <div
            className="absolute left-0 right-0 top-0 bg-white rounded-lg border-2 border-blue-400 shadow-2xl p-4 sm:p-5 z-50 pointer-events-auto"
            style={{
          ...
          >
            ...
            <div className={featured ? 'pr-12 sm:pr-16' : ''}>
