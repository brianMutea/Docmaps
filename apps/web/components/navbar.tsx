...
import { Logo, Badge } from "@docmaps/ui";
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {supportDropdownOpen && (
                <div className="absolute top-full mt-1 right-0 w-48 bg-white rounded-xl shadow-lg border border-neutral-200 py-1 z-50">
                  <button
            ...
            <div className="ml-2 pl-2 border-l border-neutral-200">
              <Link
                ...
                className="inline-flex items-center gap-2 h-9 px-4 text-sm font-semibold text-white bg-gradient-to-r from-primary-600 to-primary-700 rounded-lg hover:from-primary-700 hover:to-primary-800 transition-all shadow-md hover:shadow-lg"
              >
          ...
          <div className="md:hidden py-4 border-t border-neutral-200/50">
            <nav className="flex flex-col gap-1">
              ...
              <div className="pt-3 mt-2 border-t border-neutral-200/50">
                <Link
                  href="https://docmaps-editor.vercel.app/"
                  className="flex items-center justify-center gap-2 w-full h-10 px-4 text-sm font-semibold text-white bg-gradient-to-r from-primary-600 to-primary-700 rounded-lg hover:from-primary-700 hover:to-primary-800 transition-all"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  <Plus className="h-4 w-4" />
                  Try Mapping
