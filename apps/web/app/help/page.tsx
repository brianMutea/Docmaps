  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        ...
        <div id="getting-started" className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-2">
                Click "Create Map" from your dashboard. Fill in the basic information:
              </p>
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">3. Add Nodes</h3>
              <p className="text-sm sm:text-base text-gray-600 mb-2">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">4. Connect Nodes</h3>
              <p className="text-sm sm:text-base text-gray-600 mb-2">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">5. Publish Your Map</h3>
              <p className="text-sm sm:text-base text-gray-600 mb-2">
        ...
        {/* Editor Guide */}
        <div id="editor-guide" className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
          <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Canvas Controls</h3>
              <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-1 ml-2 sm:ml-4">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Node Editing</h3>
              <p className="text-sm sm:text-base text-gray-600 mb-2">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Auto-Layout</h3>
              <p className="text-sm sm:text-base text-gray-600 mb-2">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">View Options</h3>
              <ul className="list-disc list-inside text-sm sm:text-base text-gray-600 space-y-1 ml-2 sm:ml-4">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Saving</h3>
              <p className="text-sm sm:text-base text-gray-600 mb-2">
        ...
        {/* Keyboard Shortcuts */}
        <div id="keyboard-shortcuts" className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
          <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            <div className="flex items-center justify-between p-2 sm:p-3 bg-gray-50 rounded-lg">
              <span className="text-sm sm:text-base text-gray-900 font-medium">Save</span>
              <kbd className="px-2 sm:px-3 py-1 bg-white border border-gray-300 rounded text-xs sm:text-sm font-mono">
                ⌘/Ctrl + S
              </kbd>
            </div>
            <div className="flex items-center justify-between p-2 sm:p-3 bg-gray-50 rounded-lg">
              <span className="text-sm sm:text-base text-gray-900 font-medium">Delete Selected</span>
              <kbd className="px-2 sm:px-3 py-1 bg-white border border-gray-300 rounded text-xs sm:text-sm font-mono">
                Delete
              </kbd>
            </div>
            <div className="flex items-center justify-between p-2 sm:p-3 bg-gray-50 rounded-lg">
              <span className="text-sm sm:text-base text-gray-900 font-medium">Deselect All</span>
              <kbd className="px-2 sm:px-3 py-1 bg-white border border-gray-300 rounded text-xs sm:text-sm font-mono">
                Esc
              </kbd>
            </div>
            <div className="flex items-center justify-between p-2 sm:p-3 bg-gray-50 rounded-lg">
              <span className="text-sm sm:text-base text-gray-900 font-medium">Zoom In/Out</span>
              <kbd className="px-2 sm:px-3 py-1 bg-white border border-gray-300 rounded text-xs sm:text-sm font-mono">
                Mouse Wheel
              </kbd>
            </div>
        ...
        {/* Best Practices */}
        <div id="best-practices" className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
          <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Keep It Simple</h3>
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Use Clear Labels</h3>
              <p className="text-sm sm:text-base text-gray-600">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Add Rich Descriptions</h3>
              <p className="text-sm sm:text-base text-gray-600">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Organize Hierarchically</h3>
              <p className="text-sm sm:text-base text-gray-600">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Link to Documentation</h3>
              <p className="text-sm sm:text-base text-gray-600">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">Use Status Indicators</h3>
              <p className="text-sm sm:text-base text-gray-600">
