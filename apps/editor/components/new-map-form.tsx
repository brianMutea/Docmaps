        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
          ...
          <div className="p-6">
            <button
              ...
              className="w-full group rounded-xl border-2 border-dashed border-gray-200 p-6 text-center hover:border-blue-400 hover:bg-blue-50/50 transition-all"
            >
              {selectedTemplate ? (
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-blue-600 font-medium group-hover:underline">Click to change</p>
                </div>
              ) : (
                <div className="space-y-2">
                  <div className="w-12 h-12 mx-auto rounded-xl bg-gray-100 group-hover:bg-blue-100 flex items-center justify-center transition-colors">
                    <Layers className="h-6 w-6 text-gray-400 group-hover:text-blue-500 transition-colors" />
                  </div>
                  <p className="font-semibold text-gray-900">Choose a Template</p>
                  <p className="text-sm text-gray-500">Start with a pre-built structure or blank canvas</p>
                </div>
              )}
            </button>
          </div>
