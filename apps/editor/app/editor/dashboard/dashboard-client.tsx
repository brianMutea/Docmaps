...
export function DashboardClient({ maps: initialMaps, analytics }: DashboardClientProps) {
  ...
  return (
    <div className="space-y-8">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">{analytics.totalMaps}</p>
              </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 sm:col-span-2">
            <div className="flex items-center justify-between">
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-gray-600 mb-2">Most Popular Map</p>
        ...
        {analytics.recentViews.length > 0 && (
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Recent Views Activity</h3>
      ...
      {/* Maps Section */}
      <div>
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Your Maps</h2>
